    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            ?>
                ...
                <p class="lead">
                    <span> BY - </span> <a href="index.php"><?php echo $post_author; ?></a>
                </p>
                ...
                <div class="well">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="comment_author" class="form-control form-control-user">
                        </div>

                        <div class="form-group">
                            <label for="comment_email">Email</label>
                            <input type="email" name="comment_email" class="form-control form-control-user">
                        </div>
